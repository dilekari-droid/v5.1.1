    ...
    private suspend fun applyDiscoveryFilter(prefix: String? = null) {
        ...
        val filtered = base.filter { x ->
            ...
            when (selectedFilter) {
                ...
                DiscoveryFilter.LONG -> OpportunityUiPolicy.directionLabel(x) == "LONG"
                DiscoveryFilter.SHORT -> OpportunityUiPolicy.directionLabel(x) == "SHORT"
                DiscoveryFilter.WATCH -> OpportunityUiPolicy.directionLabel(x) == "İZLE"
                DiscoveryFilter.STRONG_LONG -> OpportunityUiPolicy.directionLabel(x) == "LONG" && OpportunityUiPolicy.isStrong(x)
                DiscoveryFilter.STRONG_SHORT -> OpportunityUiPolicy.directionLabel(x) == "SHORT" && OpportunityUiPolicy.isStrong(x)
