...
INSTALL = os.getenv("BORSA_BENCHMARK_INSTALL_ID", "ci-benchmark-v5416").strip()
    ...
    try:
        with httpx.Client(base_url=BASE, headers=headers, timeout=TIMEOUT, follow_redirects=False) as client:
            ...
            for timeframe in TIMEFRAMES:
                ...
                before_quota = before_health.json().get("quota") or {}
                ...
                after_quota = after_health.json().get("quota") or {}
                ...
                report["timeframes"].append({
                    ...
                    "quotaDelta": metric_delta(before_quota, after_quota),
                })
